# -*- coding: utf-8 -*-
#
# pcstools documentation build configuration file, created by
...
project = u'pcstools'
copyright = u'2019, Mathias Svensson'
...
latex_documents = [
    ('index', 'pcstools.tex', u'pcstools Documentation',
     u'2019, Mathias Svensson', 'manual'),
]
...
man_pages = [
    ('index', 'pcstools', u'pcstools Documentation',
     [u'2019, Mathias Svensson'], 1)
]
...
texinfo_documents = [
    ('index', 'pcstools', u'pcstools Documentation',
     u'', 'pcstools', 'Exploit toolkit for the PCS course.',
     'Miscellaneous'),
]
...
def linkcode_resolve(domain, info):
    ...
    return "https://github.com/DIKU-PCS/pcstools/blob/%s/%s" % (branch, filename)
