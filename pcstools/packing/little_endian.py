...
def unpack8(s):
    ...
    The integer is unpacked as a 8-bit, unsigned, little-endian values.
...
def unpack16(s):
    ...
    The integer is unpacked as a 16-bit, unsigned, little-endian values.
...
def unpack32(s):
    ...
    The integer is unpacked as a 32-bit, unsigned, little-endian values.
...
def unpack64(s):
    ...
    The integer is unpacked as a 64-bit, unsigned, little-endian values.
